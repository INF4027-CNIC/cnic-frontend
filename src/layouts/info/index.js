            ...
            <div className="content_information"> 
              ...
              <div className="topElement_information">
                ...
                <div className="firstTopElt">
                  <div className="infoTitle" >Information personnelle</div>
               ...
               <div className="firstTopElt">
                <div className="infoTitle" >Information supplementaires</div>
                  <div className="infoDesc">
              ...
              <div className="BottomElement">
                <div className="firstTopElt">
                  <div className="infoTitle" >Information complementaires</div>
                  <div className="infoDesc">
